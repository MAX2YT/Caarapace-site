...
export default function ProductIntroSection({
    ...
    return (
        <section className="relative w-full min-h-[80vh] bg-[#FAF8F5] overflow-hidden">
            {/* Background Pattern */}
            ...
            <div className="container mx-auto relative z-10 h-full px-6 py-16 lg:py-24">
                <div className="flex flex-col lg:flex-row items-stretch gap-12 lg:gap-16 h-full">
                    {/* Left Content Side */}
