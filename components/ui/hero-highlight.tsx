...
export const HeroHighlight = ({
    ...
    return (
        <div
            className={cn(
                "group relative flex h-screen w-full items-center justify-center bg-white",
                containerClassName,
            )}
...
export const Highlight = ({
    ...
    return (
        <motion.span
            ...
            className={cn(
                `relative inline-block rounded-lg bg-gradient-to-r from-[#BD0F46] to-[#BD0F46]/80 px-1 pb-1 text-white`,
                className,
            )}
        >
            {children}
